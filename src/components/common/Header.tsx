      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            {/* Active User Switcher Dropdown & Logout */}
            <div className="relative flex items-center gap-1.5">
              ...
              {/* Direct 1-Click Header Logout Button */}
              <button
                onClick={logout}
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-bold bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 transition-colors shadow-xs"
              ...
              {showUserMenu && (
                <div className="absolute right-0 top-full mt-1.5 w-80 rounded-2xl bg-white shadow-2xl border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 divide-y divide-slate-100">
                  
                  {/* Current Active User Profile Summary */}
                  <div className="px-4 py-2.5 bg-slate-50/80 rounded-t-xl">
                    ...
                    <div className="text-xs font-bold text-slate-900 mt-1">{currentUser.fullName}</div>
                  ...
                  <div className="p-2 space-y-1">
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-xl text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100 flex items-center justify-between transition-colors"
                    >
                      <div className="flex items-center gap-2">
